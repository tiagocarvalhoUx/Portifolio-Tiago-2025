...
const Work = () => {
  return (
    <div className="h-full bg-primary/30 py-36 flex items-center">
      <Circles />
      <div className="container mx-[2%] mt-12">
        <div className="flex flex-col xl:flex-row gap-x-8">
          ...
          <div className="text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0">
            ...
            >
              ...
              (Vite): Desenvolvimento ágil e otimizado de aplicações web com
              React, aproveitando a velocidade do Vite para um build eficiente.
              UI/UX Design: Foco em experiências intuitivas, seguindo princípios
